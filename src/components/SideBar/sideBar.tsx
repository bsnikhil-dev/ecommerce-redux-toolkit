...
const Sidebar = () => {
    ...
    const { isFalse, handleClose } = useContext(AppContext).sideBar;
    const { cart, clearCart, itemAmount, total } = useContext(AppContext).cart;
    
    return (
        <div
            className={`${isFalse ? "right-0" : "-right-full"
